...
## Project Task 2
For project task 2, I will be doing a parameter input system (input_parameters.yaml). In addition, I will also doing Advanced Documentation ([Github Wiki](https://github.com/caquigley/array_aggregator/wiki)).
